# UM Monopoly — Project Requirements
...
2. **Report** with two parts:
   - **Part A — Conceptual Design:** sketches, storyline, storyboard, character + world design
   - **Part B — Technical:** explanation of each tool used in prototype development
...
**Universiti Malaya: The Board** — a digital Monopoly-style board game where 2–4 players take on the role of UM students competing to "graduate" successfully. Players roll dice, traverse a board themed around UM faculties and landmarks, buy and upgrade properties (faculties), draw event cards reflecting UM campus life (assignment deadlines, makan at KKR, parking saman, scholarship wins), and aim to be the last financially-solvent student or the first to reach a target score. The game blends classic Monopoly mechanics with UM cultural references for entertainment and nostalgia value.
...
|----|-------------|----------|
| FR-01 | Support 2–4 local players (hot-seat turn-based) | Must |
...
| FR-07 | Jail mechanic (DTC tile) — skip turns or pay fine | Must |
...
| NFR-02 | Game session length: 30–60 minutes typical |
...
- **Avatars:** 4 selectable student characters (e.g. nerd, athlete, artsy, foodie) — purely cosmetic
...
- **Interaction:** Mouse-driven — click dice to roll, click tiles for info, click buttons for actions
...
- **Primary:** UM students, alumni, prospective students (ages 17–30)
...
- No copyrighted music — use royalty-free or original SFX
- Disclaimer slide in credits: "Fan project, not affiliated with University Malaya"

### 5.7 Competition Mode

- **2–4 player local hot-seat**, fully **competitive** (last player standing wins)
...
### 6.1 Board Tiles (40 total — standard Monopoly layout)

| Position | Tile Type | Name |
|----------|-----------|------|
| 0 | Corner | **Main Gate (GO)** — collect RM 200 |
| 1 | Property | Kolej Kediaman 1 (KK1) |
| 2 | Card | Akademik Card |
| 3 | Property | Kolej Kediaman 2 (KK2) |
| 4 | Tax | Yuran Pengajian — pay RM 200 |
...
| 38 | Tax | Saman Parking — pay RM 100 |
| 39 | Property | Vice-Chancellor's Office |

### 6.2 Card Examples

**Akademik Cards (academic events):**
- "Scored Dean's List — collect RM 200"
- "Failed final exam — pay RM 150"
- "Scholarship awarded — collect RM 300"
- "Plagiarism case — go to DTC"

**Kampus Cards (campus life events):**
- "Free makan at KKR — collect RM 50"
- "Kena saman parking — pay RM 100"
- "Won UM Idol — collect RM 250"
- "Kantin food poisoning — pay RM 75 medical"
...
1. 2–4 players can play a full game from start to finish
